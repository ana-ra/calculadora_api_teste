...
from service.service.main_service import Lowercaseservice
...
from swagger_api.service.service.main_service import CalculadoraService
##from swagger_api.service.service.main_service import Lowercaseservice
...
class MainService(Resource):
    ...
    def post(self) -> dict:
        try:
            ...
            main_service = CalculadoraService()
            resp = main_service.executar_calc(dados_request)
